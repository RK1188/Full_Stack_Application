...
const FeedbackForm = () => {
  ...
  return (
    ...
    <NavBar/>
    <FormContainer>
    <Typography variant="h5" gutterBottom style={{color:"black",marginLeft:"120px"}}>
    Feedback 
    </Typography>
    <form onSubmit={handleSubmit}>
        ...
        />
        <Box sx={{ "& > legend": { mt: 2 } }}>
          <Typography component="legend" style={{color:"black"}}>Rating</Typography>
          <Rating
            name="simple-controlled"
            value={formData.star} // Set the value from formData
            onChange={handleRatingChange} // Update the formData on rating change
            style={{border:"2px solid",paddingRight:"65px",color:"green"}}
          />
          </Box>
        <br/>
